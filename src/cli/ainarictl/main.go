...
func init() {
	...
	ainari_resources.Init_Route_Commands(rootCmd)
	ainari_resources.Init_NetworkFilter_Commands(rootCmd)
	ainari_resources.Init_NetworkCrypto_Commands(rootCmd)
	ainari_resources.Init_FloatingIp_Commands(rootCmd)
	ainari_resources.Init_NetworkInterface_Commands(rootCmd)
